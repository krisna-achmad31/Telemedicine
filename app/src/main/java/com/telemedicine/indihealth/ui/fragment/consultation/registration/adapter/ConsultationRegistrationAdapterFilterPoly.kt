package com.telemedicine.indihealth.ui.fragment.consultation.registration.adapter
...
class ConsultationRegistrationAdapterFilterPoly :
    RecyclerView.Adapter<ConsultationRegistrationAdapterFilterPoly.ViewHolder>() {
